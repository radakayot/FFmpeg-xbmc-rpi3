...
#ifndef AVCODEC_ARM_MMAL_HEVC_MISC_H
#define AVCODEC_ARM_MMAL_HEVC_MISC_H

#include "config.h"
#if HAVE_NEON_INLINE && !CONFIG_THUMB

static av_noinline void ff_hevc_mmal_copy_vert_v2h_neon(uint8_t *dst, const uint8_t *src,
...
static av_noinline void ff_hevc_mmal_copy_vert_h2v_neon(uint8_t *dst, const uint8_t *src,
                                                       int pixel_shift, int height,
...
static av_noinline void ff_hevc_mmal_copy_vert_v2v_neon(uint8_t *dst, const uint8_t *src,
                                                       int pixel_shift, int height,
...
#define ff_hevc_mmal_copy_vert ff_hevc_mmal_copy_vert_neon
static inline void ff_hevc_mmal_copy_vert_neon(uint8_t *dst, const uint8_t *src,
                                              int pixel_shift, int height,
                                              ptrdiff_t stride_dst, ptrdiff_t stride_src)
{
    if (stride_dst == 1 << pixel_shift)
        ff_hevc_mmal_copy_vert_v2h_neon(dst, src, pixel_shift, height, stride_src);
    else if (stride_src == 1 << pixel_shift)
        ff_hevc_mmal_copy_vert_h2v_neon(dst, src, pixel_shift, height, stride_dst);
    else
        ff_hevc_mmal_copy_vert_v2v_neon(dst, src, pixel_shift, height, stride_dst, stride_src);
}

#endif /* HAVE_NEON_INLINE */

#endif /* AVCODEC_ARM_MMAL_HEVC_MISC_H */
