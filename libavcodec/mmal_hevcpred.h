...
#ifndef AVCODEC_MMAL_HEVCPRED_H
#define AVCODEC_MMAL_HEVCPRED_H
...
typedef struct HEVCMMALPredContext {
    void (*intra_pred)(const struct HEVCMMALContext * const s,
    ...
    void (*intra_pred_c)(const struct HEVCMMALContext * const s,
                          const enum IntraPredMode mode, const unsigned int x0, const unsigned int y0,
                          const unsigned int avail, const unsigned int log2_size);
...
void ff_hevc_mmal_pred_init(HEVCMMALPredContext *hpc, int bit_depth);

#endif /* AVCODEC_MMAL_HEVCPRED_H */
