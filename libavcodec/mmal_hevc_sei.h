...
#ifndef AVCODEC_MMAL_HEVC_SEI_H
#define AVCODEC_MMAL_HEVC_SEI_H
 ...
 * parsing.
 *
 * @param s HEVCMMALContext.
 */
void ff_hevc_mmal_reset_sei(HEVCSEIContext *s);

#endif /* AVCODEC_MMAL_HEVC_SEI_H */
