...
static int decode_nal_sei_pic_timing(HEVCSEIContext *s, GetBitContext *gb, const HEVCMMALParamSets *ps,
                                     void *logctx, int size)
{
    ...
    sps = (HEVCMMALSPS*)ps->sps_list[s->active_seq_parameter_set_id]->data;
...
static int decode_nal_sei_prefix(GetBitContext *gb, void *logctx, HEVCSEIContext *s, const HEVCMMALParamSets *ps,
                                 int type, int size)
{
    switch (type) {
...
static int decode_nal_sei_message(GetBitContext * const gb, void * const logctx, HEVCSEIContext * const s,
                                  const HEVCMMALParamSets * const ps, const int nal_unit_type)
{
    int payload_type = 0;
    int payload_size = 0;
    int byte = 0xFF;
...
int ff_hevc_mmal_decode_nal_sei(GetBitContext *gb, void *logctx, HEVCSEIContext *s,
                           const HEVCMMALParamSets *ps, int type)
{
    int ret;
...
void ff_hevc_mmal_reset_sei(HEVCSEIContext *s)
{
