...
#ifndef AVCODEC_MMAL_HEVCDSP_H
#define AVCODEC_MMAL_HEVCDSP_H

#include "hevc.h"
#include "get_bits.h"

struct HEVCMMALMvField;

#define MAX_PB_SIZE 64

#define MMAL_HEVC_SAO_BUF_STRIDE 160


typedef struct MMALSAOParams {
...
typedef struct HEVCDSPContext {
    ...
    void (*sao_edge_restore[2])(uint8_t *_dst, uint8_t *_src, ptrdiff_t _stride_dst, ptrdiff_t _stride_src,
                                struct MMALSAOParams *sao, int *borders, int _width, int _height, int c_idx,
    ...
    uint32_t (*hevc_deblocking_boundary_strengths)(int pus, int dup, const struct HEVCMMALMvField *curr, const struct HEVCMMALMvField *neigh,
...
void ff_hevc_mmal_dsp_init(HEVCDSPContext *hpc, int bit_depth);

extern const int8_t ff_hevc_mmal_epel_filters[7][4];
extern const int8_t ff_hevc_mmal_qpel_filters[3][16];

void ff_hevc_mmal_dsp_init_ppc(HEVCDSPContext *c, const int bit_depth);
void ff_hevc_mmal_dsp_init_x86(HEVCDSPContext *c, const int bit_depth);
void ff_hevcdsp_mmal_init_arm(HEVCDSPContext *c, const int bit_depth);
void ff_hevc_mmal_dsp_init_mips(HEVCDSPContext *c, const int bit_depth);
#endif /* AVCODEC_MMAL_HEVCDSP_H */
